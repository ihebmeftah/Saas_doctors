...
interface ReceptionistsListModalProps {
  receptionists: User[];
  isOpen: boolean;
  onClose: () => void;
  onAdd: () => void;
...
export default function ReceptionistsListModal({
  receptionists,
  isOpen,
  onClose,
  onAdd,
}: ReceptionistsListModalProps) {
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-green-100 mt-1">
                  {receptionists.length} receptionist(s) in this clinique
                </p>
              </div>
              <button
                onClick={onClose}
          ...
          <div className="p-6">
            {receptionists.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">No receptionists assigned yet</p>
              </div>
            ) : (
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {receptionists.map((receptionist) => (
                  ...
                  >
                    <div className="flex-shrink-0 h-12 w-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex items-center justify-center text-white font-semibold">
